...
Singleton {
    ...
    readonly property var moduleNames: ["launcher", "dashboard", "overview", "powermenu", "tools", "presets", "windowswitcher", "workspaceswitcher"]
    ...
    Component {
        ...
        QtObject {
            ...
            property bool workspaceswitcher: false
        }
    }
