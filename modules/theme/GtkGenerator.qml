...
QtObject {
    ...
    function generate(Colors) {
        ...
        // Permitir que el usuario extienda con estilos extra que NO se sobreescriben.
        // El @import va antes de los @define-color: el cascade de GTK aplica las
        // últimas definiciones, así que gtk-extra.css usa los colores definidos abajo.
        let css = "/* GTK Colors generated by Ambxst */\n\n"
        css += `@import url(\\"file://${home}/.config/gtk-4.0/gtk-extra.css\\");\n\n`
